class Drug < ApplicationRecord
  ...
  searchkick language: "korean", word_start: [:name], word_middle: [:name, :ingr_kor_name, :ingr_eng_name], word: [:name], synonyms: [["aspirin", "acetylsalicylic acid"],["paracetamol", "acetaminophen"], ["viagra", "sildenafil"], ["cialis", "tadalafil"], ["valproic acid", "divalproex"]]
